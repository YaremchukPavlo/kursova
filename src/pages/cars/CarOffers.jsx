      ...
      <div className="rer col-12">
        {currentItems.map((car, index) => (          
            <div key={index}className="car-offer-item card card-body mt-3 d-flex flex-row">
              ...
              <div className="col-3 p-1  d-flex justify-content-center"><img className="card card-body" src={car.image}alt={car.mark}style={{ maxWidth: "200px" }}/></div>

              <div className=" col-5 m-2 d-flex justify-content-center align-items-center flex-column" style={{ position: 'relative' }}>
                <div className="col-12 d-flex justify-content-between" style={{ position: 'absolute', bottom: 100 }}>

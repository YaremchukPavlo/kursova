...
function HPgues() {
  ...
  return (
    <div className="App">
      ...
      <div className='row d-flex justify-content-center m-1' style={{height : '660px'}}>
      <h2 className='text-center'>Новини</h2>
      {news.map((item) => (
        <div key={item.id} className="news-item col-3 card card-body p-3 m-2" style={{maxHeight : '340px'}}>
          <h5>{item.title}</h5>
